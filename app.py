...
class RegisterForm(Form):
    ...
    Email = StringField('Email', validators = [InputRequired(), Email(message='Invalid email')], render_kw={"placeholder":"Email ID","id":"email","autocomplete":"off","onfocus":"this.removeAttribute('readonly');" })    
    Phone = StringField('Phone', validators = [InputRequired(),Length(min = 10, max = 13, message = 'Enter your valid mobile number')], render_kw={"placeholder":"Contact No.","type":"number","id":"phone","autocomplete":"off", "onfocus":"this.removeAttribute('readonly');" })
